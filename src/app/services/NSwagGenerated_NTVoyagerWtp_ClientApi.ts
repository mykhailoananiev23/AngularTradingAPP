...
namespace Nutcracker.ClientApi.NTVoyagerWtp {
...
export class NTVoyagerApiWtp {
     ...
     * @return Success
     */
    indexInstruments(): Observable<IndexInstrumentDTO[]> {
    ...
    protected processIndexInstruments(response: HttpResponseBase): Observable<IndexInstrumentDTO[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    chartDataBasic(pesk: string, interval: string): Observable<ChartDataPointDTO[]> {
    ...
    protected processChartDataBasic(response: HttpResponseBase): Observable<ChartDataPointDTO[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    chartDataTechnical(pesk: string, fromDate: Date, toDate: Date): Observable<ChartDataOhlcDto[]> {
    ...
    protected processChartDataTechnical(response: HttpResponseBase): Observable<ChartDataOhlcDto[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    search(searchString: string): Observable<SearchInstrument[]> {
    ...
    protected processSearch(response: HttpResponseBase): Observable<SearchInstrument[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    marketMovers(exchange: string, moverType: string): Observable<MarketMoverRow[]> {
    ...
    protected processMarketMovers(response: HttpResponseBase): Observable<MarketMoverRow[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    newsHeadlines(exchange: string): Observable<NewsHeadline[]> {
    ...
    protected processNewsHeadlines(response: HttpResponseBase): Observable<NewsHeadline[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    tradableInstrumentsForPesk(pesk: string): Observable<TradableInstrumentDTO[]> {
    ...
    protected processTradableInstrumentsForPesk(response: HttpResponseBase): Observable<TradableInstrumentDTO[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    positions(accountId: string): Observable<PositionRow[]> {
    ...
    protected processPositions(response: HttpResponseBase): Observable<PositionRow[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    orders(accountId: string): Observable<OrderBookRow[]> {
    ...
    protected processOrders(response: HttpResponseBase): Observable<OrderBookRow[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    trades(accountId: string): Observable<TradesBookRow[]> {
    ...
    protected processTrades(response: HttpResponseBase): Observable<TradesBookRow[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    positionSummary(accountId: string): Observable<PositionSummary[]> {
    ...
    protected processPositionSummary(response: HttpResponseBase): Observable<PositionSummary[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    tradingAccounts(): Observable<TradingAccountDTO[]> {
    ...
    protected processTradingAccounts(response: HttpResponseBase): Observable<TradingAccountDTO[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
    ...
    protected processV2(response: HttpResponseBase): Observable<WatchlistDTO[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    instrumentsAll(watchlistId: string): Observable<WatchlistInstrumentDTO[]> {
    ...
    protected processInstrumentsAll(response: HttpResponseBase): Observable<WatchlistInstrumentDTO[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
