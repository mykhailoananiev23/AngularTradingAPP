...
export class NTVoyagerApiWtp {
     ...
     * @return Success
     */
    register(body: RegisterUserCommand | undefined): Observable<EntityCreateResponse> {
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<EntityCreateResponse>;
                }
            } else
                return _observableThrow(response_) as any as Observable<EntityCreateResponse>;
        }));
    }

    protected processRegister(response: HttpResponseBase): Observable<EntityCreateResponse> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<IndexInstrumentDTO[]>;
                }
            } else
                return _observableThrow(response_) as any as Observable<IndexInstrumentDTO[]>;
        }));
    }

    protected processIndexInstruments(response: HttpResponseBase): Observable<IndexInstrumentDTO[] | IndexInstrumentDTO> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    updatePesks(body: IndexUpdatePesksCommand | undefined): Observable<GenericResponse> {
    ...
    protected processUpdatePesks(response: HttpResponseBase): Observable<GenericResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    chartDataBasic(pesk: string, interval: string): Observable<ChartDataPointDTO[] | ChartDataPointDTO> {
        let url_ = this.baseUrl + "/api/wtp/MarketData/v2/ChartDataBasic/{pesk}/{interval}";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<ChartDataPointDTO[]>;
                }
            } else
                return _observableThrow(response_) as any as Observable<ChartDataPointDTO[]>;
        }));
    }

    protected processChartDataBasic(response: HttpResponseBase): Observable<ChartDataPointDTO[] | ChartDataPointDTO> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    chartDataTechnical(pesk: string, fromDate: Date, toDate: Date): Observable<ChartDataOhlcDto[] | ChartDataOhlcDto> {
        let url_ = this.baseUrl + "/api/wtp/MarketData/v2/ChartDataTechnical/{pesk}/{fromDate}/{toDate}";
        if (pesk === undefined || pesk === null)
            throw new Error("The parameter 'pesk' must be defined.");
        url_ = url_.replace("{pesk}", encodeURIComponent("" + pesk));
        ...
        url_ = url_.replace("{toDate}", encodeURIComponent(toDate ? "" + toDate.toISOString() : "null"));
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<ChartDataOhlcDto[]>;
                }
            } else
                return _observableThrow(response_) as any as Observable<ChartDataOhlcDto[]>;
        }));
    }

    protected processChartDataTechnical(response: HttpResponseBase): Observable<ChartDataOhlcDto[] | ChartDataOhlcDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    search(searchString: string): Observable<SearchInstrument[] | SearchInstrument> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<SearchInstrument[]>;
                }
            } else
                return _observableThrow(response_) as any as Observable<SearchInstrument[]>;
        }));
    }

    protected processSearch(response: HttpResponseBase): Observable<SearchInstrument[] | SearchInstrument> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    marketMovers(exchange: string, moverType: string): Observable<MarketMoverRow[] | MarketMoverRow> {
        let url_ = this.baseUrl + "/api/wtp/MarketData/v2/MarketMovers/{exchange}/{moverType}";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                ...
                return _observableThrow(response_) as any as Observable<MarketMoverRow[]>;
        }));
    }

    protected processMarketMovers(response: HttpResponseBase): Observable<MarketMoverRow[] | MarketMoverRow> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    newsHeadlines(exchange: string): Observable<NewsHeadline[] | NewsHeadline> {
        let url_ = this.baseUrl + "/api/wtp/MarketData/v2/NewsHeadlines/{exchange}";
        if (exchange === undefined || exchange === null)
            throw new Error("The parameter 'exchange' must be defined.");
        url_ = url_.replace("{exchange}", encodeURIComponent("" + exchange));
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                ...
                return _observableThrow(response_) as any as Observable<NewsHeadline[]>;
        }));
    }

    protected processNewsHeadlines(response: HttpResponseBase): Observable<NewsHeadline[] | NewsHeadline> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    orderSubmit(body: OrderCreateCommand | undefined): Observable<EntityCreateResponse> {
    ...
    protected processOrderSubmit(response: HttpResponseBase): Observable<EntityCreateResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    orderCancel(body: OrderCancelCommand | undefined): Observable<EntityCreateResponse> {
    ...
    protected processOrderCancel(response: HttpResponseBase): Observable<EntityCreateResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    tradableInstrumentsForPesk(pesk: string): Observable<TradableInstrumentDTO[] | TradableInstrumentDTO> {
        let url_ = this.baseUrl + "/api/wtp/Private/v2/TradableInstrumentsForPesk/{pesk}";
        if (pesk === undefined || pesk === null)
            throw new Error("The parameter 'pesk' must be defined.");
        url_ = url_.replace("{pesk}", encodeURIComponent("" + pesk));
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<TradableInstrumentDTO[]>;
                }
            } else
                return _observableThrow(response_) as any as Observable<TradableInstrumentDTO[]>;
        }));
    }

    protected processTradableInstrumentsForPesk(response: HttpResponseBase): Observable<TradableInstrumentDTO[] | TradableInstrumentDTO> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
    ...
    positions(accountId: string): Observable<PositionRow[] | PositionRow> {
        let url_ = this.baseUrl + "/api/wtp/Private/v2/Account/Positions/{accountId}";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                ...
                return _observableThrow(response_) as any as Observable<PositionRow[]>;
        }));
    }

    protected processPositions(response: HttpResponseBase): Observable<PositionRow[] | PositionRow> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    positionDetail(positionId: string | undefined, tradeId: string): Observable<PositionRow> {
        let url_ = this.baseUrl + "/api/wtp/Private/v2/Account/PositionDetail/{tradeId}?";
    ...
    protected processPositionDetail(response: HttpResponseBase): Observable<PositionRow> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
    ...
    orders(accountId: string): Observable<OrderBookRow[] | OrderBookRow> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                ...
                return _observableThrow(response_) as any as Observable<OrderBookRow[]>;
        }));
    }

    protected processOrders(response: HttpResponseBase): Observable<OrderBookRow[] | OrderBookRow> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    orderDetail(orderId: string | undefined, tradeId: string): Observable<OrderBookRow> {
        let url_ = this.baseUrl + "/api/wtp/Private/v2/Account/OrderDetail/{tradeId}?";
        if (tradeId === undefined || tradeId === null)
            throw new Error("The parameter 'tradeId' must be defined.");
        url_ = url_.replace("{tradeId}", encodeURIComponent("" + tradeId));
        if (orderId === null)
    ...
    protected processOrderDetail(response: HttpResponseBase): Observable<OrderBookRow> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
    ...
    trades(accountId: string): Observable<TradesBookRow[] | TradesBookRow> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                ...
                return _observableThrow(response_) as any as Observable<TradesBookRow[]>;
        }));
    }

    protected processTrades(response: HttpResponseBase): Observable<TradesBookRow[] | TradesBookRow> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
    ...
    tradeDetail(tradeId: string): Observable<TradesBookRow> {
        let url_ = this.baseUrl + "/api/wtp/Private/v2/Account/TradeDetail/{tradeId}";
        if (tradeId === undefined || tradeId === null)
            throw new Error("The parameter 'tradeId' must be defined.");
        url_ = url_.replace("{tradeId}", encodeURIComponent("" + tradeId));
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processTradeDetail(response: HttpResponseBase): Observable<TradesBookRow> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    positionSummary(accountId: string): Observable<PositionSummary[] | PositionSummary> {
        let url_ = this.baseUrl + "/api/wtp/Private/v2/Account/PositionSummary/{accountId}";
        if (accountId === undefined || accountId === null)
            throw new Error("The parameter 'accountId' must be defined.");
        url_ = url_.replace("{accountId}", encodeURIComponent("" + accountId));
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<PositionSummary[]>;
                }
            } else
                return _observableThrow(response_) as any as Observable<PositionSummary[]>;
        }));
    }

    protected processPositionSummary(response: HttpResponseBase): Observable<PositionSummary[] | PositionSummary> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
    ...
    details(fixSessionName: string): Observable<FixSessionDetailDTO> {
        let url_ = this.baseUrl + "/api/wtp/Private/v2/FixSessions/Details/{fixSessionName}";
        if (fixSessionName === undefined || fixSessionName === null)
            throw new Error("The parameter 'fixSessionName' must be defined.");
        url_ = url_.replace("{fixSessionName}", encodeURIComponent("" + fixSessionName));
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<FixSessionDetailDTO>;
                }
            } else
                return _observableThrow(response_) as any as Observable<FixSessionDetailDTO>;
        }));
    }

    protected processDetails(response: HttpResponseBase): Observable<FixSessionDetailDTO> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
    ...
    instruments(fixSessionName: string): Observable<TradableInstrumentDTO> {
        let url_ = this.baseUrl + "/api/wtp/Private/v2/FixSessions/Instruments/{fixSessionName}";
        if (fixSessionName === undefined || fixSessionName === null)
            throw new Error("The parameter 'fixSessionName' must be defined.");
        url_ = url_.replace("{fixSessionName}", encodeURIComponent("" + fixSessionName));
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processInstruments(response: HttpResponseBase): Observable<TradableInstrumentDTO> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    calculateOrderCosts(body: OrderCostsCommand | undefined): Observable<OrderCostsDTO> {
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                ...
                return _observableThrow(response_) as any as Observable<OrderCostsDTO>;
        }));
    }

    protected processCalculateOrderCosts(response: HttpResponseBase): Observable<OrderCostsDTO> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<TradingAccountDTO[]>;
                }
            } else
                return _observableThrow(response_) as any as Observable<TradingAccountDTO[]>;
        }));
    }

    protected processTradingAccounts(response: HttpResponseBase): Observable<TradingAccountDTO[] | TradingAccountDTO> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
    ...
    v2(): Observable<WatchlistDTO[] | WatchlistDTO> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                ...
                return _observableThrow(response_) as any as Observable<WatchlistDTO[]>;
        }));
    }

    protected processV2(response: HttpResponseBase): Observable<WatchlistDTO[] | WatchlistDTO> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    instrumentsAll(watchlistId: string): Observable<WatchlistInstrumentDTO[] | WatchlistInstrumentDTO> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<WatchlistInstrumentDTO[]>;
                }
            } else
                return _observableThrow(response_) as any as Observable<WatchlistInstrumentDTO[]>;
        }));
    }

    protected processInstrumentsAll(response: HttpResponseBase): Observable<WatchlistInstrumentDTO[] | WatchlistInstrumentDTO> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    addNew(body: WatchlistCreateCommand | undefined): Observable<GenericResponse> {
    ...
    protected processAddNew(response: HttpResponseBase): Observable<GenericResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    rename(body: WatchlistRenameCommand | undefined): Observable<GenericResponse> {
    ...
    protected processRename(response: HttpResponseBase): Observable<GenericResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    updatePesks2(body: WatchlistUpdatePesksCommand | undefined): Observable<GenericResponse> {
    ...
    protected processUpdatePesks2(response: HttpResponseBase): Observable<GenericResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    delete(body: WatchlistDeleteCommand | undefined): Observable<GenericResponse> {
    ...
    protected processDelete(response: HttpResponseBase): Observable<GenericResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
...
export class IndexUpdatePesksCommand implements IIndexUpdatePesksCommand {
    ...
    init(_data?: any) {
        if (_data) {
            if (Array.isArray(_data["pesks"])) {
                this.pesks = [] as any;
                for (let item of _data["pesks"])
                    this.pesks!.push(item);
            }
        }
    }
    ...
    toJSON(data?: any) {
        ...
        if (Array.isArray(this.pesks)) {
            data["pesks"] = [];
            for (let item of this.pesks)
                data["pesks"].push(item);
        }
        return data;
    }
}
...
export class OrderBookRow implements IOrderBookRow {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.timeInForceDate = _data["timeInForceDate"] ? new Date(_data["timeInForceDate"].toString()) : <any>undefined;
    ...
    toJSON(data?: any) {
        ...
        data["timeInForceDate"] = this.timeInForceDate ? this.timeInForceDate.toISOString() : <any>undefined;
...
export class PositionRow implements IPositionRow {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.symbol = _data["symbol"];
            this.tesk = _data["tesk"];
            this.positionDate = _data["positionDate"] ? new Date(_data["positionDate"].toString()) : <any>undefined;
    ...
    toJSON(data?: any) {
        ...
        data["symbol"] = this.symbol;
        data["tesk"] = this.tesk;
        data["positionDate"] = this.positionDate ? this.positionDate.toISOString() : <any>undefined;
...
export class TradesBookRow implements ITradesBookRow {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.tradeDateTime = _data["tradeDateTime"] ? new Date(_data["tradeDateTime"].toString()) : <any>undefined;
    ...
    toJSON(data?: any) {
        ...
        data["tradeDateTime"] = this.tradeDateTime ? this.tradeDateTime.toISOString() : <any>undefined;
...
export class WatchlistUpdatePesksCommand implements IWatchlistUpdatePesksCommand {
    watchlistId?: string | undefined;
    pesks?: string[] | undefined;
